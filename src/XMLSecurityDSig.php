...
use DOMXPath;
use Exception;
use Flogar\XMLSecLibs\Util\XPath;
...
class XMLSecurityDSig
{
  ...
  <ds:SignedInfo>
    ...
    const BASE_TEMPLATE = '<Signature Id="SignFlogzar" xmlns="http://www.w3.org/2000/09/xmldsig#"><SignedInfo><SignatureMethod /></SignedInfo></Signature>';
